...
In physical terms, let's take an electron. When we measure the spin of the electron, it can either spin up (clockwise) or spin down (anticlockwise). According to quantum mechanics, the electrons have a superposition when not measured which is a superposition of spin up and down. This means that it has a complex combination of both. 
